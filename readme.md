...
-   `styledJSX` (_false_) - If true, [styled-jsx](https://github.com/vercel/styled-jsx) integration will be added (babel plugin, and SSR integration). You need to run `npm install styled-jsx` when enabling this.
